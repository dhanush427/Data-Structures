...
public class JuliaSetProgramSet extends JPanel implements AdjustmentListener, ActionListener {
    JFrame frame;
    ...
    public JuliaSetProgramSet() {
        ...
        JLabel[] temp = {new JLabel("A: " + scrollBars[0].getValue()), new JLabel("B: " + scrollBars[1].getValue()), new JLabel("Zoom: " + scrollBars[2].getValue()), new JLabel("Hue: " + scrollBars[3].getValue() + " "), new JLabel("Equation: " + scrollBars[4].getValue() + 1), new JLabel("RGB SHIFTER: " + scrollBars[5].getValue())};
        labels = temp;
        for (JLabel j : labels)
            labelPanel.add(j);
        ...
        scrollBars[5].setToolTipText("RGB SHIFTER");
    ...
    public void repaintLabels() {
        ...
        labels[5].setText("RGB SHIFTER: " + scrollBars[5].getValue());
    }

    public static void main(String[] args) {
        JuliaSetProgramSet app = new JuliaSetProgramSet();
    }
}
