...
public class JuliaProgramCompleted extends JPanel implements AdjustmentListener, ActionListener
{
	JFrame frame;
	...
	{
		JuliaProgramCompleted app = new JuliaProgramCompleted();
	}
}